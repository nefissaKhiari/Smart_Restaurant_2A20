...
public:
    ...
    void setupUi(QDialog *paiement)
    {
        ...
        paiement->resize(1204, 930);
        paiement->setStyleSheet(QStringLiteral("background-image: url(:/images/background1.jpg);"));
        horizontalLayout = new QHBoxLayout(paiement);
        ...
        groupBox->setGeometry(QRect(630, 50, 451, 211));
...
"}"));
        ...
        groupBox_2->setGeometry(QRect(630, 270, 461, 201));
...
"}"));
        ...
        groupBox_3->setGeometry(QRect(620, 480, 461, 121));
...
""));
        ...
        groupBox_9->setGeometry(QRect(520, 600, 221, 151));
        ...
        pushButton_9->setGeometry(QRect(140, 0, 71, 31));
...
""));
        ...
        image->setGeometry(QRect(-30, -130, 1211, 10));
        ...
        digitalclock_2->setStyleSheet(QStringLiteral("background-image: url(:/images/Empty.png);"));
        date_2 = new QLabel(tab);
        date_2->setObjectName(QStringLiteral("date_2"));
        date_2->setGeometry(QRect(790, 620, 164, 31));
        date_2->setStyleSheet(QStringLiteral("background-image: url(:/images/Empty.png);"));
        text1 = new QLabel(tab);
        text1->setObjectName(QStringLiteral("text1"));
        text1->setGeometry(QRect(10, 710, 291, 61));
        text1->setStyleSheet(QLatin1String("background-image: url(:/images/Empty.png);\n"
...
"color: rgb(170, 0, 0);"));
        ...
        textf->setGeometry(QRect(80, 10, 641, 71));
        QFont font;
        font.setPointSize(36);
        font.setBold(true);
        font.setWeight(75);
        textf->setFont(font);
        textf->setStyleSheet(QStringLiteral("background-image: url(:/images/Empty.png);"));
        textf->setScaledContents(false);
...
"}"));
        ...
        music = new QPushButton(tab);
        music->setObjectName(QStringLiteral("music"));
        music->setGeometry(QRect(1040, 840, 93, 28));
        music->setStyleSheet(QLatin1String("QPushButton\n"
"\n"
"{\n"
"  \n"
"  border-radius: 10px;\n"
...
"}"));
        ...
        play->setGeometry(QRect(1040, 830, 93, 28));
...
"    border: 4px solid QLinearGradient( x1: 2, y1: 2, x2: 2, y2: 3, stop: 0 #08E8DE , stop: 3 #d7801a);\n"
"}"));
        pause = new QPushButton(tab);
        pause->setObjectName(QStringLiteral("pause"));
        pause->setGeometry(QRect(670, 830, 93, 28));
...
"}"));
        ...
        stop->setGeometry(QRect(900, 830, 93, 28));
...
"}"));
        ...
        progressBar->setGeometry(QRect(850, 800, 301, 21));
        progressBar->setValue(0);
        volume = new QSlider(tab);
        volume->setObjectName(QStringLiteral("volume"));
        volume->setGeometry(QRect(770, 830, 160, 22));
        volume->setOrientation(Qt::Horizontal);
        mute = new QPushButton(tab);
        mute->setObjectName(QStringLiteral("mute"));
        mute->setGeometry(QRect(940, 840, 93, 28));
...
"}"));
        ...
        groupBox_5->setStyleSheet(QStringLiteral("background-image: url(:/images/Empty.png);"));
...
"}"));
        ...
        groupBox_8->setStyleSheet(QStringLiteral("background-image: url(:/images/Empty.png);"));
...
""));
        ...
        imprimerbt_2->setStyleSheet(QLatin1String("QPushButton\n"
"\n"
"{\n"
"  \n"
"  border-radius: 10px;\n"
...
"}"));
        ...
        date->setStyleSheet(QStringLiteral("background-image: url(:/images/Empty.png);"));
        ...
        digitalclock->setStyleSheet(QStringLiteral("background-image: url(:/images/Empty.png);"));
...
"}"));
        ...
        groupBox_11->setGeometry(QRect(210, 590, 700, 80));
        groupBox_11->setMaximumSize(QSize(16777215, 80));
        groupBox_11->setStyleSheet(QStringLiteral("background-image: url(:/images/Empty.png);"));
        gridLayout = new QGridLayout(groupBox_11);
        gridLayout->setObjectName(QStringLiteral("gridLayout"));
        play_2 = new QPushButton(groupBox_11);
        play_2->setObjectName(QStringLiteral("play_2"));
        play_2->setStyleSheet(QLatin1String("QPushButton\n"
"\n"
"{\n"
"  \n"
"  border-radius: 10px;\n"
...
"}"));
        QIcon icon;
        icon.addFile(QStringLiteral(":/new/prefix1/Icons/022-video.png"), QSize(), QIcon::Normal, QIcon::Off);
        play_2->setIcon(icon);

        gridLayout->addWidget(play_2, 0, 4, 1, 1);

        directory = new QPushButton(groupBox_11);
        directory->setObjectName(QStringLiteral("directory"));
        directory->setStyleSheet(QLatin1String("QPushButton\n"
"\n"
"{\n"
"  \n"
"  border-radius: 10px;\n"
...
"}"));
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/new/prefix1/Icons/015-folder.png"), QSize(), QIcon::Normal, QIcon::Off);
        directory->setIcon(icon1);

        gridLayout->addWidget(directory, 0, 5, 1, 1);

        comboBox_3 = new QComboBox(groupBox_11);
        comboBox_3->setObjectName(QStringLiteral("comboBox_3"));

        gridLayout->addWidget(comboBox_3, 0, 3, 1, 1);

        horizontalSlider_2 = new QSlider(groupBox_11);
        horizontalSlider_2->setObjectName(QStringLiteral("horizontalSlider_2"));
        horizontalSlider_2->setMaximumSize(QSize(35645, 16777215));
        horizontalSlider_2->setOrientation(Qt::Horizontal);

        gridLayout->addWidget(horizontalSlider_2, 0, 1, 1, 2);

        endTime = new QLabel(groupBox_11);
        endTime->setObjectName(QStringLiteral("endTime"));

        gridLayout->addWidget(endTime, 0, 6, 1, 1);

        volume_2 = new QLabel(groupBox_11);
        volume_2->setObjectName(QStringLiteral("volume_2"));
        volume_2->setMaximumSize(QSize(60, 16777215));

        gridLayout->addWidget(volume_2, 0, 0, 1, 1);

        horizontalSlider = new QSlider(groupBox_11);
        horizontalSlider->setObjectName(QStringLiteral("horizontalSlider"));
        horizontalSlider->setAutoFillBackground(false);
        horizontalSlider->setInputMethodHints(Qt::ImhNone);
        ...
        groupBox_12->setGeometry(QRect(210, 94, 700, 490));
    ...
    {
        paiement->setWindowTitle(QApplication::translate("paiement", "Paiement et Factures", Q_NULLPTR));
        ...
        pushButton_9->setText(QApplication::translate("paiement", "Recherche", Q_NULLPTR));
        ...
        textf->setText(QApplication::translate("paiement", "<html><head/><body><p><span style=\" font-size:28pt; text-decoration: underline; color:#aa0000;\">Gestion Des Factures </span></p></body></html>", Q_NULLPTR));
        pushButton_4->setText(QApplication::translate("paiement", "Afficher", Q_NULLPTR));
        imm->setText(QString());
        music->setText(QApplication::translate("paiement", "music", Q_NULLPTR));
        play->setText(QApplication::translate("paiement", "play", Q_NULLPTR));
        pause->setText(QApplication::translate("paiement", "pause", Q_NULLPTR));
        stop->setText(QApplication::translate("paiement", "stop", Q_NULLPTR));
        mute->setText(QApplication::translate("paiement", "mute", Q_NULLPTR));
        ...
        play_2->setText(QApplication::translate("paiement", "Play", Q_NULLPTR));
        directory->setText(QApplication::translate("paiement", "Dir", Q_NULLPTR));
        comboBox_3->clear();
        comboBox_3->insertItems(0, QStringList()
         << QApplication::translate("paiement", "1x", Q_NULLPTR)
         << QApplication::translate("paiement", "0.5x", Q_NULLPTR)
         << QApplication::translate("paiement", "2x", Q_NULLPTR)
        );
        endTime->setText(QApplication::translate("paiement", "00:00:00", Q_NULLPTR));
        volume_2->setText(QApplication::translate("paiement", "Volume:", Q_NULLPTR));
        groupBox_12->setTitle(QString());
        tabWidget->setTabText(tabWidget->indexOf(tab_3), QApplication::translate("paiement", "MyPlayer", Q_NULLPTR));
    } // retranslateUi
