...
{
    ui->setupUi(this);
    QPixmap pix("C:/Users/Fakher/Desktop/GestionReservation/GESTION DE RESERVATION FINcopie/Atelier_Connexion/bkg.jpg");
        ui->img->setPixmap(pix);
        QPixmap pic("C:/Users/Fakher/Desktop/GestionReservation/GESTION DE RESERVATION FINcopie/Atelier_Connexion/bkg.jpg");
            ui->img2 -> setPixmap(pic);

            QPixmap pik("C:/Users/Fakher/Desktop/GestionReservation/GESTION DE RESERVATION FINcopie/Atelier_Connexion/restau.png");
                ui-> imageresto -> setPixmap(pik);
                QPixmap pia("C:/Users/Fakher/Desktop/GestionReservation/GESTION DE RESERVATION FINcopie/Atelier_Connexion/restau.png");
